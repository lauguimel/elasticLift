...
Line(19) = {1, 17}; Transfinite Line {19} = Nhleft*2.2 Using Progression Rhleft;  
Line(20) = {17, 18}; Transfinite Line {20} = Nvfirstblock Using Progression Rvfirstblock; 
Line(21) = {18, 2}; Transfinite Line {21} = Nhleft*2.2 Using Progression Rhleft; 

Line(22) = {20, 4}; Transfinite Line {22} = Nhleft*2.2 Using Progression Rhleft;  
Line(23) = {20, 19}; Transfinite Line {23} = Nvfirstblock Using Progression Rvfirstblock; 
Line(24) = {19, 3}; Transfinite Line {24} = Nhleft*2.2 Using Progression Rhleft;
...
Line(25) = {5, 21}; Transfinite Line {25} = Nhleft*2.2 Using Progression Rhleft;  
Line(26) = {22, 21}; Transfinite Line {26} = Nvlastblock Using Progression Rvlastblock; 
Line(27) = {22, 7}; Transfinite Line {27} = Nhleft*2.2 Using Progression Rhleft; 
 
Line(28) = {24, 6}; Transfinite Line {28} = Nhleft*2.2 Using Progression Rhleft;  
Line(29) = {23, 24}; Transfinite Line {29} = Nvlastblock Using Progression Rvlastblock; 
Line(30) = {23, 8}; Transfinite Line {30} = Nhleft*2.2 Using Progression Rhleft; 
